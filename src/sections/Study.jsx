      ...
      <div className="container mx-auto">
        <div className="flex flex-col mt-10 gap-4">
          <Card className={"md:col-span-2"}>
            <div className="flex flex-col p-8 md:py-8 md:px-10 gap-8">
              ...
              {currentStudy.state ? (
                <div className="flex items-center justify-center h-32 outline outline-2 text-white outline-white/40 font-semibold rounded-lg">
                  <p className="text-lg">Study in Progress 💻</p>
                </div>
              ) : (
                <img
                  src={currentStudy.image}
                  alt={`${currentStudy.title} Certificate`}
                  className="rounded-md mt-8 -mb-4 h-[600px]"
                />
              )}
            </div>
